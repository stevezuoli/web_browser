...
void QWSLinuxInputKbPrivate::capture_input(void)
{
    int on = 1 ;
...
void QWSLinuxInputKbPrivate::release_input(void)
{
    int off = 0 ;
...
Qt::KeyboardModifiers QWSLinuxInputKbPrivate::GetCurModifiers()
{
...
void QWSLinuxInputKbPrivate::fiveway_activity(int)
{
    int unicode, keycode ;
...
void QWSLinuxInputKbPrivate::k3_activity(int)
{
    int unicode, keycode ;
    Qt::KeyboardModifiers mods ;
    bool ispressed, isautorpt ;
...
void QWSLinuxInputKbPrivate::activity(int)
{
    int unicode, keycode ;
    Qt::KeyboardModifiers mods ;
    bool ispressed, isautorpt ;
