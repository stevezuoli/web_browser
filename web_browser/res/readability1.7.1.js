...
var readability = {
    ...
    init: function() {
        ...
        if(!articleContent) {
            ...
            articleContent.innerHTML = errormsgs.homepageErr;
        ...
        **/
        if((window.location.protocol + "//" + window.location.host + "/") === window.location.href)
        {
            ...
            var rootWarning = document.createElement('p');
                ...
                rootWarning.innerHTML = errormsgs.homePageErrWithLink;
    ...
    **/
    ...
    prepArticle: function (articleContent) {
        ...
        /* Remove noscript tags to address an issue where they are seen as content */
        readability.clean(articleContent, "noscript");
