...
void BrowserMainWindow::setupMenu()
{
    ...
    // TODO. Fixed the issue of rendering then add it back
    //menu_actions[MA_Rotate] = menu_.addAction(tr("Rotate"), this, SLOT(rotate()));
    //menu_.addSeparator();
...
void BrowserMainWindow::rotate()
{
    int rotate_degree = SystemManager::instance()->screenTransformation();
    qDebug("Rotate Degree:%d", rotate_degree);
    rotate_degree = rotate_degree == 0 ? 90 : 0;
    SystemManager::instance()->setTransformations(rotate_degree);
}
