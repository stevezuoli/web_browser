...
DuokanLabel::DuokanLabel(QWidget * parent)
: QLabel(parent, 0)
{
...
DuokanLabel::DuokanLabel(const QString & text, QWidget *parent)
: QLabel(text, parent)
{
    setStyleSheet(LABEL_STYLE);
    setFocusPolicy(Qt::NoFocus);
...
DuokanLabel::~DuokanLabel()
{
}

void DuokanLabel::useTitleBarStyle()
{
    setStyleSheet(TITLEBAR_STYLE);
}

void DuokanLabel::useMessageStyle(int w)
{
...
void DuokanLabel::squeezeText(Qt::TextElideMode mode)
{
