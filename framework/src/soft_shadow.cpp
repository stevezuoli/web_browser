...
DuokanShadowWidget::DuokanShadowWidget(QWidget *parent, Qt::Orientation o)
...
DuokanShadowWidget::~DuokanShadowWidget()
{
}

void DuokanShadowWidget::resizeEvent(QResizeEvent *e)
{
    /*
    QPainterPath path;
...
void DuokanShadowWidget::paintEvent(QPaintEvent * event)
{
...
QPainterPath DuokanShadowWidget::getHorizontalPath()
{
...
QPainterPath DuokanShadowWidget::getVerticalPath()
{
