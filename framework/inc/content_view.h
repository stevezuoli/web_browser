...
public:
    ...
    void setFocusWaveform(duokan::screen::ScreenProxy::Waveform w);
    duokan::screen::ScreenProxy::Waveform focusWaveform();
...
private:
    ...
    duokan::screen::ScreenProxy::Waveform waveform_;
};
...
public:
    ...
    static const QString type();
    inline DuokanLineEdit * innerEdit() { return &inner_edit_; }
